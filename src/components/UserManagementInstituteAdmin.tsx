...
const UserManagementInstituteAdmin = ({ user: currentUser }: { user: User }) => {
    ...
    <div className="space-y-6">
      <div className="bg-white p-8 rounded-3xl shadow-sm border border-slate-100">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
          <div>
            <h2 className="text-2xl font-bold text-slate-800 mb-2">Institute Admin</h2>
          ...
          <button
            onClick={() => {
              ...
              alert('Registration link copied to clipboard! You can now share this on WhatsApp, Email, or other social media platforms.');
            }}
            className="flex items-center space-x-2 bg-emerald-100 hover:bg-emerald-200 text-emerald-700 px-4 py-2 rounded-xl font-bold transition-colors"
          >
            <LinkIcon size={18} />
...
export default UserManagementInstituteAdmin;
