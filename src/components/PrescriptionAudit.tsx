...
const PrescriptionAudit = ({ user }: { user: User }) => {
  ...
  return (
    <div className="space-y-8">
      <div className="flex justify-between items-center print:hidden">
        <div>
          <h2 className="text-2xl font-bold text-slate-800">Prescription Audit System</h2>
          <p className="text-slate-500">WHO-Based Quality Evaluation Module</p>
        </div>
      </div>
