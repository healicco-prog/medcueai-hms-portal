...
const PrescriptionUploadErrorPage = ({ user }: { user: User }) => {
  ...
  return (
    <div className="min-h-[calc(100vh-100px)] pt-8 max-w-5xl mx-auto space-y-10 px-4">
      ...
      <div className="bg-white px-8 py-6 rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-slate-100 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          <h2 className="text-3xl font-black text-slate-800 tracking-tight">Medication Error Prescription Upload</h2>
          <p className="text-slate-500 font-medium mt-1">Securely upload and crop prescription images for medication error auditing</p>
        </div>
      ...
      <div className="bg-white p-8 rounded-[2rem] shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-slate-100">
        <PrescriptionUploader onUploadComplete={fetchPrescriptions} uploadEndpoint="/api/med-error-prescriptions/upload" />
      </div>
...
export default PrescriptionUploadErrorPage;
